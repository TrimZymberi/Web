...
<body>
        ...
        <div id="whole-box">
            <div id="main-container">
                    ...
                    <h1>Administrator Tools | News</h1>
                </div>
                <div class="menu-section">
                    <form action="../../auth/news-add.php" method="post">
                    <div class="form-group">
                        <label for="header"><p>Header</p></label>
                        <input type="text" name="header" class="form-control" placeholder="Write your news header here!">
                    </div>
                    <div class="form-group">
                        <label for="summary"><p>Summary</p></label>
                        <input type="text" name="summary" class="form-control" placeholder="Write your news summary here!">
                    </div>
                    
                    <div class="form-group image">
                        <label for="image"><p>Image</p></label>
                        <input type="file" name="image" alt="" accept="image/*" value="Upload Image" >
                    </div>
